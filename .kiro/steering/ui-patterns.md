...
```erb
<div>
  <%= form.label :field_name, class: "block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2" %>
...
<dl class="grid grid-cols-1 sm:grid-cols-2 gap-6">
  <div>
    <dt class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Field Label</dt>
